...
(function () {
  const strings = {
    ...
    "sell.step2Title": "ステップ2：暗号資産を送付",
    "sell.step2Desc": "受け取った入金アドレスと金額を以下に貼り付けてください。送金画面がその内容で開き、ご自身で確認して送金を確定します。",
    "sell.networkHint": "どのネットワークで送るかは Transak が指定します。現在は {network} です。Transak が別のネットワークを求める場合は、先にネットワークを切り替えてください。",
    "sell.depositPlaceholder": "入金アドレス（0x...）",
    "sell.amountPlaceholder": "提示された金額",
    "sell.reviewInSendBtn": "送金画面で確認",
    "sell.invalidAddress": "有効なアドレスではないようです。Transak に表示された通り正確にコピーしてください。",
    ...
    "buy.title": "暗号資産を購入",
    "buy.transakBtn": "Transakで購入",
    "buy.transakNote": "新しいタブでTransakを開きます。このアドレスは入力済みです。",
    "buy.description1": "購入機能は、独立した第三者サービスである Transak によって提供されています。Token Exchange がお客様の支払い情報に触れることは一切ありません。",
    "buy.noThirdPartyCallout": "すでに暗号資産をお持ちですか?Transakを使わずに、必要なものへ直接オンチェーンでスワップできます -- 第三者もサインアップも不要です。",
    "buy.noThirdPartySwapBtn": "代わりにスワップする",
    "buy.coinbaseBtn": "代わりにCoinbaseで購入",
    "buy.coinbaseNote": "新しいタブでCoinbaseを開き、このアドレスが自動入力されます。Transakとは別の、Coinbase運営のサービスです。",

    "sell.title": "現金化して売却",
    "sell.transakBtn": "Transakで売却",
    "sell.transakNote": "新しいタブでTransakを開きます。そちらの手順を完了し、表示された入金アドレスを下に貼り付けてください。",
    "sell.description1": "売却機能は、購入機能と同じ第三者サービスである Transak によって提供されています -- Token Exchange がお客様の受取情報に触れることは一切ありません。",
    "sell.coinbaseBtn": "代わりにCoinbaseで売却",
    "sell.coinbaseNote": "新しいタブでCoinbaseを開きます。Transakとは別の、Coinbase運営のサービスです。",
  ...
  const faq = [
    ...
    },
    {
      id: "buy-not-working",
      chip: "購入機能が使えません",
      keywords: ["購入 使えない", "購入できない", "購入 動かない", "購入 未設定", "Transak", "買えない"],
      answer: "購入画面ではTransak、Coinbase、Onramperの3つ(それぞれ独立した外部のオンランプ)を利用できます。「Buy isn't set up yet」と表示される場合は、このウォレットの開発者が決済プロバイダーの設定をまだ完了していないという意味で、ウォレット内では解決できません。TransakとCoinbaseは、アドレス入力済みの状態で新しいタブで開きます。Onramperはアプリ内で開きます。いずれの場合も、Token Exchangeが支払い情報に触れることはありません。",
    },
    {
      id: "reset-wallet",
      chip: "ウォレットをリセットするには？",
