...
(function () {
  const strings = {
    ...
    "buy.moonpayMutedNote": "MoonPay はこちらではまだ本番稼働していません -- 下記の Coinbase での購入は今すぐご利用いただけます。",
    ...
    "sell.moonpayMutedNote": "MoonPay はこちらではまだ本番稼働していません -- 下記の Coinbase での売却は今すぐご利用いただけます。",
