...
(function () {
  const strings = {
    ...
    "buy.title": "暗号資産を購入",
    "buy.description1": "購入はTransak(独立した外部サービス)によって提供されます。Token Exchangeが支払い情報に触れることはありません。",
    "buy.description2Html": "Transakが新しいタブで開き、受取アドレスは入力済みになります:",
    "buy.continueBtn": "Transakへ進む",
  ...
  const faq = [
    ...
    },
    {
      ...
      answer: "「購入」ボタンは、アドレス入力済みの状態でTransak(独立した外部のオンランプ)を新しいタブで開きます。「Buy isn't set up yet」と表示される場合は、このウォレットの開発者がTransakの設定をまだ完了していないという意味で、ウォレット内では解決できません。Token Exchangeが支払い情報に触れることはありません。",
    },
    {
      id: "reset-wallet",
      chip: "ウォレットをリセットするには？",
