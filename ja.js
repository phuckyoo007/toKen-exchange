...
(function () {
  const strings = {
    ...
    "onboarding.siteNotice": "ウェブ版 -- 鍵はこのブラウザ内にのみ保存されます。",
    "onboarding.siteNoticeToggle": "安全ですか？タップして詳しく見る",
    "onboarding.siteNoticeFull": "ウェブサイトはインストール済みのブラウザ拡張機能に比べ、フィッシングや偽ドメインの標的になりやすいため、MetaMask などのウォレットは鍵を保持するウェブサイトを提供していません。迷った場合は、日常利用にはブラウザ拡張機能の方が安全です。実際の資金でこのサイトを信頼する前に、このページの README をご確認ください。",
    ...
    "account.title": "サインイン",
    "account.intro": "任意機能です。アカウントは表示通貨・言語・ウォッチリストをデバイス間で同期します。ウォレットや鍵、リカバリーフレーズを保存することは一切ありません。",
    "account.tabSignIn": "サインイン",
    "account.tabCreate": "アカウントを作成",
    "account.usernameLabel": "ユーザー名",
    "account.usernameHint": "3〜24文字：英字、数字、アンダースコア。",
    "account.passwordLabel": "パスワード",
    "account.confirmLabel": "パスワード（確認）",
    "account.walletWarning": "このパスワードではウォレットを復元できません。リカバリーフレーズを安全に保管してください -- 資金を復元できる唯一の方法です。",
    "account.signInSubmit": "サインイン",
    "account.createSubmit": "アカウントを作成",
    "account.working": "処理中...",
    "account.synced": "同期しました。",
    "account.signedInAs": "{username} としてサインイン中",
    "account.syncNote": "同期中：表示通貨、言語、ウォッチリスト。",
    "account.signOut": "サインアウト",
    "account.deleteLabel": "アカウントを削除",
    "account.deletePlaceholder": "確認用パスワード",
    "account.deleteBtn": "アカウントを削除",
    "account.deleteNeedsPassword": "アカウントを削除するにはパスワードを入力してください。",
    "account.deleteConfirm": "アカウントと同期設定が削除されます。ウォレットと資金には影響しません。続行しますか？",
    "account.entryBtn": "サインイン / アカウント作成",
    "account.errUsername": "ユーザー名は3〜24文字（英字、数字、アンダースコア）にしてください。",
    "account.errPasswordShort": "パスワードは10文字以上にしてください。",
    "account.errMismatch": "パスワードが一致しません。",
    "account.errBadLogin": "ユーザー名またはパスワードが正しくありません。",
    "account.errTaken": "そのユーザー名は既に使用されています。",
    "account.errRateLimited": "試行回数が多すぎます。しばらくしてからもう一度お試しください。",
    "account.errUnavailable": "現在アカウント機能は利用できません。",
    "account.errGeneric": "問題が発生しました。もう一度お試しください。",
