...
(function () {
  const strings = {
    ...
    "main.livePricesTitle": "Preços ao vivo",
    "main.predictionsTitle": "Mercados em alta",
    ...
    "prices.naText": "n/d",
    "prices.watchlistToggle": "Toque na estrela para fixar no topo",
    "prices.cardUnavailable": "Preços indisponíveis no momento.",
    ...
    "prices.noStablecoinYet": "Ainda não existe um equivalente cripto estabelecido para {currency} -- isto é apenas uma taxa de câmbio fiduciária, não um token.",
    "prices.currencySwapNote": "Troque por {stablecoin}, o equivalente cripto mais próximo do {currency} -- você terá um token real on-chain, não o {currency} em si.",
    "prices.currencySwapSwitchNetwork": "{stablecoin} acompanha o {currency} na rede {network}. Mude de rede para trocar por ele lá.",
    ...
    "coin.buyBtn": "Comprar com {currency}",
    "coin.sellBtn": "Vender para meu banco ({currency})",
    "prices.currencyFallbackNote": "Ainda não há um token de {currency} líquido, então isso troca por USDC, uma stablecoin em dólares americanos. Use Vender para sacar para seu banco em {code}.",
    "sell.step2Title": "Etapa 2: envie sua cripto",
    "sell.step2Desc": "Cole abaixo o endereço de depósito e o valor que você recebeu. Isso abre Enviar já preenchido, e você revisa e confirma o envio.",
    "sell.networkHint": "A Transak informa em qual rede enviar. Você está na {network}. Se a Transak pedir outra rede, troque de rede primeiro.",
    "sell.depositPlaceholder": "Endereço de depósito (0x...)",
    "sell.amountPlaceholder": "Valor cotado",
    "sell.reviewInSendBtn": "Revisar em Enviar",
    "sell.invalidAddress": "Isso não parece um endereço válido. Copie exatamente como a Transak mostra.",
    "sell.invalidAmount": "Digite o valor como um número, ou deixe em branco.",
    ...
    "coin.swapUnavailableSwitchNetworkToken": "{symbol} não pode ser trocado aqui, mas existe uma versão verificada na rede {network} -- mude para lá para trocá-la, ou use Adicionar token se você quis dizer outro endereço.",
    "coin.switchNetworkBtn": "Mudar para {network} para trocar",
    "coin.swapUnavailableAddKnownToken": "{symbol} não roda diretamente na rede {network}, mas {tokenSymbol} é a versão lastreada em {symbol} própria da rede -- adicione-a abaixo para ter exposição real e negociável aqui.",
    "coin.swapUnavailableAddNativeToken": "{symbol} realmente roda diretamente na rede {network} -- só ainda não foi adicionado à sua wallet aqui. Adicione-o abaixo para ter e negociar o ativo real.",
    ...
    "predictions.title": "Mercados em alta",
    "predictions.description": "Probabilidades públicas dos mercados de previsão da Polymarket -- apenas informativo. A Token Exchange não faz apostas nem mantém posições em seu nome; nenhuma informação da sua wallet é enviada para consultá-las.",
    "predictions.loading": "Carregando...",
    "predictions.empty": "Nenhum mercado em alta no momento.",
    "predictions.cardUnavailable": "Mercados indisponíveis no momento.",
    "predictions.volSuffix": "vol. 24h",
    "predictions.openOnPolymarket": "Apostar na Polymarket ↗",
    "predictions.linkDisclosure": "Tocar em um mercado abre o próprio site da Polymarket em uma nova aba, onde suas próprias regras de cadastro, elegibilidade e localização se aplicam -- a Token Exchange não tem participação nisso.",
    "buy.title": "Comprar cripto",
    "buy.transakBtn": "Comprar com a Transak",
    "buy.transakNote": "Abre a Transak em uma nova guia, com este endereço já preenchido.",
    ...
    "buy.coinbaseNote": "Abre a Coinbase em uma nova guia, com este endereço já preenchido. Um serviço separado da Transak, operado pela Coinbase.",

    "sell.title": "Vender por dinheiro",
    "sell.transakBtn": "Vender com a Transak",
    "sell.transakNote": "Abre a Transak em uma nova guia. Siga as etapas lá e depois cole abaixo o endereço de depósito que ela fornecer.",
    "sell.description1": "Vender funciona com a Transak, o mesmo serviço de terceiros usado pela Comprar -- a Token Exchange nunca tem acesso aos seus dados de pagamento.",
    "sell.coinbaseBtn": "Vender com a Coinbase",
    "sell.coinbaseNote": "Abre a Coinbase em uma nova guia. Um serviço separado da Transak, operado pela Coinbase.",
    "sell.coinbaseCheckBtn": "Terminei na Coinbase: obter meus dados de depósito",
    "sell.coinbaseNotReady": "A Coinbase ainda não tem uma venda concluída -- termine primeiro na guia da Coinbase e tente novamente.",
  ...
  const faq = [
    ...
    },
    {
      ...
      keywords: ["botão de comprar", "botao de comprar", "compra não funciona", "compra nao funciona", "compra não configurada", "transak", "não consigo comprar", "nao consigo comprar"],
      answer: "A tela Comprar oferece Transak, Coinbase e Onramper, serviços de on-ramp terceirizados e independentes. Se aparecer “Buy isn't set up yet”, isso significa que o desenvolvedor desta carteira ainda não terminou de configurar um provedor de pagamento -- não é algo que você possa resolver de dentro da carteira. A Transak e a Coinbase abrem em uma nova aba com seu endereço já preenchido; a Onramper abre dentro do app. Em todos os casos, a Token Exchange nunca tem acesso aos seus dados de pagamento.",
    },
    {
      id: "reset-wallet",
