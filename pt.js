...
(function () {
  const strings = {
    ...
    "buy.description2Html": "A Transak abrirá em uma nova aba com seu endereço de recebimento já preenchido:",
  ...
  const faq = [
    ...
    },
    {
      ...
      answer: "O botão Comprar abre a Transak, um serviço de on-ramp terceirizado, em uma nova aba com seu endereço já preenchido. Se aparecer “Buy isn't set up yet”, isso significa que o desenvolvedor desta carteira ainda não terminou de configurar a Transak -- não é algo que você possa resolver de dentro da carteira. A Token Exchange nunca tem acesso aos seus dados de pagamento.",
    },
    {
      id: "reset-wallet",
