...
(function () {
  const strings = {
    ...
    "onboarding.siteNotice": "Versão web -- suas chaves ficam só neste navegador.",
    "onboarding.siteNoticeToggle": "Isso é seguro? Toque para saber mais",
    "onboarding.siteNoticeFull": "Um site é um alvo mais fácil para phishing e domínios falsos do que uma extensão de navegador instalada, por isso carteiras como a MetaMask não oferecem um site que guarde chaves. Na dúvida, a extensão do navegador é a opção mais segura para o dia a dia. Veja o README desta página antes de confiar neste site com fundos reais.",
    ...
    "account.title": "Entrar",
    "account.intro": "Opcional. Uma conta sincroniza sua moeda de exibição, idioma e lista de favoritos entre dispositivos. Nunca armazena sua carteira, chaves ou frase de recuperação.",
    "account.tabSignIn": "Entrar",
    "account.tabCreate": "Criar conta",
    "account.usernameLabel": "Nome de usuário",
    "account.usernameHint": "3-24 caracteres: letras, números ou sublinhado.",
    "account.passwordLabel": "Senha",
    "account.confirmLabel": "Confirmar senha",
    "account.walletWarning": "Esta senha não pode recuperar sua carteira. Guarde bem sua frase de recuperação -- é a única forma de recuperar seus fundos.",
    "account.signInSubmit": "Entrar",
    "account.createSubmit": "Criar conta",
    "account.working": "Processando...",
    "account.synced": "Sincronizado.",
    "account.signedInAs": "Conectado como {username}",
    "account.syncNote": "Sincronizando: moeda de exibição, idioma e lista de favoritos.",
    "account.signOut": "Sair",
    "account.deleteLabel": "Excluir conta",
    "account.deletePlaceholder": "Senha para confirmar",
    "account.deleteBtn": "Excluir conta",
    "account.deleteNeedsPassword": "Digite sua senha para excluir sua conta.",
    "account.deleteConfirm": "Isso exclui sua conta e suas configurações sincronizadas. Sua carteira e seus fundos não são afetados. Continuar?",
    "account.entryBtn": "Entrar / Criar conta",
    "account.errUsername": "O nome de usuário deve ter 3-24 caracteres: letras, números ou sublinhado.",
    "account.errPasswordShort": "A senha deve ter pelo menos 10 caracteres.",
    "account.errMismatch": "As senhas não coincidem.",
    "account.errBadLogin": "Usuário ou senha incorretos.",
    "account.errTaken": "Esse nome de usuário já está em uso.",
    "account.errRateLimited": "Muitas tentativas. Aguarde e tente novamente.",
    "account.errUnavailable": "As contas não estão disponíveis no momento.",
    "account.errGeneric": "Algo deu errado. Tente novamente.",
