...
(function () {
  const strings = {
    ...
    "sell.networkHint": "Transak vous indique sur quel réseau envoyer. Vous êtes sur {network}. Si Transak demande un réseau différent, changez de réseau d'abord.",
    ...
    "sell.invalidAddress": "Cela ne ressemble pas à une adresse valide. Copiez-la exactement comme Transak l'affiche.",
    ...
    "buy.transakBtn": "Acheter avec Transak",
    "buy.transakNote": "Ouvre Transak dans un nouvel onglet, avec cette adresse déjà renseignée.",
    ...
    "buy.coinbaseNote": "Ouvre Coinbase dans un nouvel onglet, avec cette adresse déjà renseignée. Un service distinct de Transak, géré par Coinbase.",

    "sell.title": "Vendre contre de l'argent",
    "sell.transakBtn": "Vendre avec Transak",
    "sell.transakNote": "Ouvre Transak dans un nouvel onglet. Suivez les étapes, puis collez ci-dessous l'adresse de dépôt qu'il vous donne.",
    "sell.description1": "Vendre fonctionne avec Transak, le même service tiers qu'Acheter -- Token Exchange n'a jamais accès à vos informations de paiement.",
    "sell.coinbaseBtn": "Vendre avec Coinbase à la place",
    "sell.coinbaseNote": "Ouvre Coinbase dans un nouvel onglet. Un service distinct de Transak, géré par Coinbase.",
  ...
  const faq = [
    ...
    },
    {
      ...
      keywords: ["bouton acheter", "acheter ne fonctionne pas", "achat non configuré", "transak", "impossible d'acheter", "je ne peux pas acheter"],
      answer: "L'écran Acheter propose Transak, Coinbase et Onramper, des services d'achat tiers indépendants. S'il indique « L'achat n'est pas encore configuré », cela signifie que le développeur de ce portefeuille n'a pas fini de configurer un fournisseur de paiement -- vous ne pouvez pas le corriger depuis le portefeuille. Transak et Coinbase s'ouvrent dans un nouvel onglet avec votre adresse déjà renseignée ; Onramper s'ouvre directement dans l'application. Dans tous les cas, Token Exchange n'a jamais accès à vos informations de paiement.",
    },
    {
      id: "reset-wallet",
