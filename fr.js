...
(function () {
  const strings = {
    ...
    "onboarding.siteNotice": "Version web -- vos clés restent uniquement dans ce navigateur.",
    "onboarding.siteNoticeToggle": "Est-ce sûr ? Appuyez pour en savoir plus",
    "onboarding.siteNoticeFull": "Un site web est une cible plus facile pour le phishing et les domaines usurpés qu'une extension de navigateur installée, c'est pourquoi des portefeuilles comme MetaMask ne proposent pas de site web conservant les clés. En cas de doute, l'extension de navigateur est le choix le plus sûr au quotidien. Consultez le README de cette page avant de confier de vrais fonds à ce site.",
    ...
    "account.title": "Se connecter",
    "account.intro": "Facultatif. Un compte synchronise votre devise d'affichage, votre langue et votre liste de suivi entre appareils. Il ne stocke jamais votre portefeuille, vos clés ni votre phrase de récupération.",
    "account.tabSignIn": "Se connecter",
    "account.tabCreate": "Créer un compte",
    "account.usernameLabel": "Nom d'utilisateur",
    "account.usernameHint": "3 à 24 caractères : lettres, chiffres ou tiret bas.",
    "account.passwordLabel": "Mot de passe",
    "account.confirmLabel": "Confirmer le mot de passe",
    "account.walletWarning": "Ce mot de passe ne peut pas récupérer votre portefeuille. Conservez votre phrase de récupération en lieu sûr -- c'est le seul moyen de récupérer vos fonds.",
    "account.signInSubmit": "Se connecter",
    "account.createSubmit": "Créer un compte",
    "account.working": "Chargement...",
    "account.synced": "Synchronisé.",
    "account.signedInAs": "Connecté en tant que {username}",
    "account.syncNote": "Synchronisation : devise d'affichage, langue et liste de suivi.",
    "account.signOut": "Se déconnecter",
    "account.deleteLabel": "Supprimer le compte",
    "account.deletePlaceholder": "Mot de passe pour confirmer",
    "account.deleteBtn": "Supprimer le compte",
    "account.deleteNeedsPassword": "Saisissez votre mot de passe pour supprimer votre compte.",
    "account.deleteConfirm": "Cela supprime votre compte et ses paramètres synchronisés. Votre portefeuille et vos fonds ne sont pas concernés. Continuer ?",
    "account.entryBtn": "Se connecter / Créer un compte",
    "account.errUsername": "Le nom d'utilisateur doit comporter 3 à 24 caractères : lettres, chiffres ou tiret bas.",
    "account.errPasswordShort": "Le mot de passe doit comporter au moins 10 caractères.",
    "account.errMismatch": "Les mots de passe ne correspondent pas.",
    "account.errBadLogin": "Nom d'utilisateur ou mot de passe incorrect.",
    "account.errTaken": "Ce nom d'utilisateur est déjà pris.",
    "account.errRateLimited": "Trop de tentatives. Veuillez patienter puis réessayer.",
    "account.errUnavailable": "Les comptes ne sont pas disponibles pour le moment.",
    "account.errGeneric": "Une erreur s'est produite. Veuillez réessayer.",
