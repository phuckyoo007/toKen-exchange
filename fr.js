...
(function () {
  const strings = {
    ...
    "buy.description2Html": "Transak s'ouvrira dans un nouvel onglet avec votre adresse de réception déjà renseignée :",
  ...
  const faq = [
    ...
    },
    {
      ...
      answer: "Le bouton Acheter ouvre Transak, un service d'achat tiers indépendant, dans un nouvel onglet avec votre adresse déjà renseignée. S'il indique « Buy isn't set up yet », cela signifie que le développeur de ce portefeuille n'a pas fini de configurer Transak -- vous ne pouvez pas le corriger depuis le portefeuille. Token Exchange n'a jamais accès à vos informations de paiement.",
    },
    {
      id: "reset-wallet",
